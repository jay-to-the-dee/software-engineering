...
public class ParserImpTest {
    ...
    public void testWhitespaceException() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testColumnCount() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testRowCount() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testEmptyLine() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testSizeLineNotJustInts() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testNotAntInt() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testSpecifierNotDefined() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
    ...
    public void testUnsupportedSizeOfSpecifier() throws IOException, RowNumberException, RowDoesntStartWithWhitespaceException, ColumnNumberException {
